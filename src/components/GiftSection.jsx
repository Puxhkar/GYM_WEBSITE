        ...
        <section id="gift" className="py-24 bg-[#0B0F19] relative">
            <div className="container mx-auto px-6">
                ...
                <motion.div
                    ...
                    className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-cyan-600 via-indigo-700 to-purple-800 p-1 md:p-2 shadow-[0_0_50px_rgba(99,102,241,0.3)]"
                >
                    <div className="bg-[#0B0F19]/60 backdrop-blur-xl rounded-[1.3rem] md:rounded-[1.4rem] p-10 md:p-16 text-center border border-white/10 relative overflow-hidden">
                        ...
                        <div className="absolute top-0 right-0 p-8 opacity-20 hidden md:block">
                            <FaGift className="w-64 h-64 text-cyan-400 rotate-12" />
                        </div>

                        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
                            <span className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-cyan-400 to-indigo-500 text-white mb-6 shadow-xl">
                                <FaGift className="w-8 h-8" />
                            </span>
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
                                Start With A <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-indigo-300">Gift</span>
                            </h2>
                            <p className="text-xl text-gray-200 mb-4 font-medium">Claim your Free 3-Day Pass & Expert Consultation.</p>
                            <p className="text-cyan-400 text-sm font-bold uppercase tracking-widest mb-10">Limited time offer for new members</p>

                            <button
                                onClick={handleOpen}
                                className="bg-white text-indigo-900 hover:bg-gray-100 font-black text-lg py-4 px-12 rounded-full shadow-[0_10px_30px_rgba(255,255,255,0.2)] hover:shadow-[0_10px_40px_rgba(255,255,255,0.4)] hover:-translate-y-1 transition-all duration-300"
                            >
                                Get My Coupon
                            </button>
                        </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        <div>
                                            <input
                                                ...
                                                className="w-full bg-[#0B0F19] border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                                            />
                                        </div>
                                        <div>
                                            <input
                                        ...
                                        <div>
                                            <select
                                                ...
                                                className="w-full bg-[#0B0F19] border border-white/10 rounded-xl px-5 py-4 text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
                                            >
                                        ...
                                        <button
                                            type="submit"
                                            className="w-full bg-gradient-to-r from-cyan-500 to-indigo-500 text-white font-bold py-4 rounded-xl mt-4 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all"
                                        >
                                            Send My Coupon
                                        </button>
                                    </form>
